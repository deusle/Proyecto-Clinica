...
# 👉 Importamos la ventana de recetas
from ventana_recetas import VentanaRecetas
...
class Dashboard(QMainWindow):
    def __init__(self):
        ...
        btn_recetas = self.crear_boton_menu("Recetas", "icons/recetas.png", self.abrir_gestion_recetas)  # nuevo botón
        btn_salir = self.crear_boton_menu("Salir", "icons/exit.png", self.close, es_rojo=True)

        # 👉 Distribuir en la grilla como antes + recetas
        ...
        menu_layout.addWidget(btn_recetas, 2, 0)
    ...
    # 👉 Nueva función para abrir la ventana de recetas
    def abrir_gestion_recetas(self): self.abrir_ventana("recetas", VentanaRecetas)
